function [pcloud, transforms]=Projecto_Oficial_Reconstruction_v3(depth_array,rgb_array, depth_cam, rgb_cam, Rdtrgb, Tdtrgb)
...
pcloud = pcmerge(pcloud2, pcloud1, 0.0001);
